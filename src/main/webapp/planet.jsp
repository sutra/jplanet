...
<div id="sidebar">
	...
	<p>Planet OpenID is edited by <a href="mailto:${planet.adminEmail}?Subject=${planet.mailSubject}">${planet.adminName}</a>. Please mail him if you have a question or would like your blog added to the feed.</p>
	</div>
